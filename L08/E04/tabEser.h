...
esercizio_l getArrayEser(tabEser_l te); // NON necessito la setter per il vettore, tabEser viene creato quando si legge da file e non viene più modificato
int getNEser(tabEser_l te);  // analogo a sopra
